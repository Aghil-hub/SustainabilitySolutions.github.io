...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const universityData = {
    'UIUC': {
      'all': [52, 48, 71, 82, 63, 47, 86, 65, 88, 58, 69, 51, 74, 49, 53, 72, 67],
      '1': [62, 55, 48, 71],
      '2': [58, 48, 64, 52, 44],
      '3': [76, 70, 62],
      '4': [72, 58, 50, 64],
    ...
    'ASU': {
      'all': [78, 62, 85, 77, 80, 72, 91, 83, 88, 75, 89, 79, 92, 65, 70, 82, 86],
      '1': [85, 78, 71, 92],
      '2': [80, 69, 85, 76, 65],
      '3': [94, 88, 82],
      '4': [90, 75, 68, 83],
    ...
    'MSU': {
      'all': [71, 84, 79, 85, 74, 68, 77, 76, 69, 80, 78, 73, 82, 61, 88, 75, 79],
      '1': [80, 73, 66, 89],
      '2': [76, 63, 82, 70, 59],
      '3': [90, 86, 78],
      '4': [86, 72, 65, 80],
    ...
    'Penn State': {
      'all': [67, 70, 88, 75, 72, 55, 74, 80, 91, 69, 76, 68, 78, 53, 65, 87, 81],
      '1': [78, 71, 64, 85],
      '2': [72, 59, 78, 66, 54],
      '3': [88, 82, 74],
      '4': [84, 70, 63, 76],
    ...
    'FIU': {
      'all': [63, 75, 72, 66, 69, 85, 68, 71, 58, 82, 74, 55, 79, 91, 77, 70, 73],
      '1': [74, 67, 60, 83],
      '2': [70, 57, 76, 64, 52],
      '3': [86, 80, 72],
      '4': [82, 68, 61, 74],
